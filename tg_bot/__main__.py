...
HELP_STRINGS = """
ഹലോ ! എന്റെ പേര്  *{}*.
ഞാൻ ടെലിഗ്രാമിലെ ഗ്രൂപ്പ് മാനേജ്മെന്റ് ബോട്ട് ആണ്... എന്നെ പ്രവർത്തിപ്പിക്കേണ്ട വിധം ആണ് താഴെ കൊടുത്തിട്ടുള്ളത്....
...
{}
And the following:
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "ഈ പറഞ്ഞിരിക്കുന്ന commandകൾ എല്ലാം  / അല്ലെങ്കിൽ ! വെച്ച് ഉപയോഗിക്കാവുന്നതാണ്...\n")
